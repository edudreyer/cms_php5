...
$query_rsNoticia = sprintf("SELECT * FROM produto WHERE codigo = %s", GetSQLValueString($colname_rsNoticia, "int"));
...
mysql_select_db($database_banco1, $banco1);
$query_rsImgNot = sprintf("SELECT * FROM produto_imagem WHERE codigo_produto = %s", GetSQLValueString($colname_rsImgNot, "int"));
...
<div class="page-header"><h1><?php echo $row_rsNoticia['produto']; ?> <?php echo $row_rsNoticia['webcodigo']; ?></h1></div>
...
<div class="row">
    ...
    <br />
    <?php echo $row_rsNoticia['tamanho']; ?><br />
	<?php echo $row_rsNoticia['valor']; ?>
